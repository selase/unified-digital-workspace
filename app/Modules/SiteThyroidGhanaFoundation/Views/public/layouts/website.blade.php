    ...
    <div style="background: var(--tgf-dark);" class="text-sm">
        <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="#" class="text-slate-400 transition hover:text-white" aria-label="YouTube" target="_blank" rel="noopener">
        ...
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 border-t border-slate-800 pt-8 flex flex-wrap items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="#" class="text-slate-500 transition hover:text-white" target="_blank" rel="noopener" aria-label="YouTube">
