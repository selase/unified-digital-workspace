...
@section('title', 'Quality Monitoring Hub')
        ...
        <div class="kt-card p-6 lg:p-8">
            <div class="flex flex-wrap items-start justify-between gap-4">
                <div>
                    ...
                    <h1 class="mt-2 text-2xl font-semibold text-foreground">Quality Monitoring Hub</h1>
                    <p class="mt-2 text-sm text-muted-foreground">Track workplans, KPI updates, variances, and alerts with monitoring endpoints.</p>
                </div>
        ...
        <div class="kt-card p-6">
            ...
            <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                @foreach($apiLinks as $apiLink)
                    <a href="{{ $apiLink['url'] }}" class="rounded-lg bg-muted/30 p-4 transition hover:bg-muted/50">
