    ...
    <section class="grid gap-6">
        ...
        <div class="kt-card kt-card-grid min-w-full">
            <div class="kt-card-header flex-wrap gap-3">
                <h3 class="kt-card-title text-sm">Job Postings</h3>
                <form class="flex flex-wrap items-center gap-2" method="GET" action="{{ route('hrms-core.recruitment.index') }}">
                    <input
                ...
                <div class="kt-scrollable-x-auto">
                    <table class="kt-table table-auto kt-table-border">
                        ...
                        <tbody class="text-sm text-foreground">
                            ...
                            @empty
                                <tr>
                                    <td class="py-8 text-center text-muted-foreground" colspan="5">No job postings found for this filter.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
