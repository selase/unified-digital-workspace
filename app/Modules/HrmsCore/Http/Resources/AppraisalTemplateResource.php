...
/**
 * @mixin AppraisalTemplate
 */
final class AppraisalTemplateResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'sections' => AppraisalSectionResource::collection($this->whenLoaded('sections')),
