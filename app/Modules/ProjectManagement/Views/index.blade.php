...
@section('title', 'Project Management Hub')
        ...
        <div class="kt-card p-6 lg:p-8">
            <div class="flex flex-wrap items-start justify-between gap-4">
                <div>
                    ...
                    <h1 class="mt-2 text-2xl font-semibold text-foreground">Project Management Hub</h1>
                    <p class="mt-2 text-sm text-muted-foreground">Manage projects, milestones, tasks, and timelines through versioned APIs.</p>
                </div>
