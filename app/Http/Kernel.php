...
final class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'module' => Middleware\EnsureModuleEnabled::class,
        'role' => \Spatie\Permission\Middleware\RoleMiddleware::class,
        'permission' => \Spatie\Permission\Middleware\PermissionMiddleware::class,
        'role_or_permission' => \Spatie\Permission\Middleware\RoleOrPermissionMiddleware::class,
        'onboarding' => Middleware\EnsureOnboardingComplete::class,
        'auth_api_key' => Middleware\AuthenticateWithApiKey::class,
        'ensure_llm_tokens' => Middleware\EnsureTenantHasLlmTokens::class,
