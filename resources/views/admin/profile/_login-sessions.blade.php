<div class="card pt-4 mb-6 mb-xl-9">
    ...
    <div class="card-body pt-0 pb-5">
        <div class="table-responsive">
            <table class="table align-middle table-row-dashed gy-5" id="login-session-table">
                <thead class="border-bottom border-gray-200 fs-7 fw-bolder">
                    <tr class="text-start text-muted text-uppercase gs-0">
                        <th class="min-w-100px">Location</th>
                        <th>Device</th>
                        <th>IP Address</th>
                        <th class="min-w-125px">Login at</th>
                        {{--  <th class="min-w-70px">Logout at</th>  --}}
                    </tr>
                </thead>
                <tbody class="fs-6 fw-bold text-gray-600">
                    @foreach ($loginSessions as $loginSession)
                        <tr>
                            <td>{{ $loginSession->location }}</td>
                            ...
                            {{--  <td>{{ $loginSession->getLogoutTime() }}</td>  --}}
                        </tr>
                    @endforeach
                </tbody>
            </table>
