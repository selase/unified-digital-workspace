...
@section('content')
    <section class="grid gap-6">
        <div class="rounded-xl border border-border bg-background p-6 lg:p-8">
            <div class="flex flex-wrap items-start justify-between gap-4">
                <div>
                    ...
                    <h1 class="mt-2 text-2xl font-semibold text-foreground">Define New System Feature</h1>
                    <p class="mt-2 text-sm text-muted-foreground">Add entitlement metadata and link permissions to a feature flag.</p>
                </div>
        ...
        <div class="rounded-xl border border-border bg-background p-6">
            <form id="createFeatureForm" class="kt-form" action="{{ route('features.store') }}" method="POST">
                @csrf
