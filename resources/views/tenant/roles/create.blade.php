                                        ...
                                        <td>
                                            <div class="flex flex-wrap gap-3">
                                                @foreach($perms as $permission)
                                                    @php
                                                        // Strip the redundant category prefix from dotted names
                                                        // (e.g. "cms.posts.view" -> "posts.view"). Keep
                                                        // legacy "verb noun" names as-is — the category
                                                        // column already disambiguates them.
